...
# Attention is passed in in the format '32_64' to mean applying an attention block at both resolution 32x32 and 64x64.
# Just '64' will apply at 64x64.
def generator_arch(ch=64, attention="64", ksize="333333", dilation="111111"):
    arch = dict()
    arch[512] = {
...
class Generator(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        self.fp16 = G_fp16
        # Architecture dict
        self.arch = generator_arch(self.ch, self.attention)[resolution]
        ...
        self.which_bn = functools.partial(
            ...
            mybn=self.mybn,
            input_size=(
                self.shared_dim + self.z_chunk_size if self.G_shared else self.n_classes
            ),
...
def discriminator_arch(ch=64, attention="64", ksize="333333", dilation="111111"):
    arch = {}
    arch[256] = {
...
class Discriminator(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        self.fp16 = D_fp16
        # Architecture
        self.arch = discriminator_arch(self.ch, self.attention)[resolution]
    ...
    def forward(self, x, y=None):
        ...
        out = self.linear(h)
        # Get projection of final feature set onto class vectors and add to evidence
